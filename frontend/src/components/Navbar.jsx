    ...
    <header className="sticky top-0 z-50 w-full pt-3 sm:pt-4 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto transition-all duration-300">
      ...
      >
        ...
        <Link to="/" className="flex items-center gap-2 sm:gap-2.5 group shrink-0 mr-2 lg:mr-4">
          <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-full bg-white border border-slate-200/90 dark:border-slate-700/80 flex items-center justify-center p-1 shadow-sm group-hover:border-[#2EB88A]/60 group-hover:shadow-md group-hover:scale-105 transition-all overflow-hidden shrink-0">
