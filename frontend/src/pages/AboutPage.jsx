  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16 space-y-16">
      ...
      <div className="text-center max-w-3xl mx-auto space-y-6">
        <div className="w-28 h-28 sm:w-36 sm:h-36 mx-auto rounded-full bg-white dark:bg-[#071510] border-2 border-[#2EB88A]/40 p-2.5 sm:p-3 shadow-xl flex items-center justify-center overflow-hidden">
